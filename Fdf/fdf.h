...
/*   Updated: 2024/12/11 00:29:37 by maximegdfr       ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    init_draw_variables(t_point p1, t_point p2, t_bresenham *bresenham);
...
int     key_events(int keycode, void *param);
...
void    projection_trimetric(t_point *point, float alpha, float beta, float gamma);
