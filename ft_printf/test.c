...
/*   Updated: 2024/11/22 15:10:03 by maximegdfr       ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	test_alpha(void)
{
	...
	x += printf("  Originale\t:\tNULL %s NULL.\n", s);
...
void	test_mix(void)
{
	...
	x += printf("  Originale\t:\tThe int is %i or %d, the char is %c, the string is \"%s\", the hex is %x or %X, the unsigned is %u and the percent is %%.\n", 42, -42, 's', "Hello", 42, 42, 242);
...
void	test_bonus(void)
{
	...
	y = 0;
	printf("\n----------- TEST: WIDTH CHAR -----------\n\n");
	x = printf("  Originale:\tChar [%20c]\n", 'x');
	y = ft_printf("  Ft_printf:\tChar [%20c]\n", 'x');
	printf("Printf = %d, ft_printf = %d\n\n", x, y);
	printf("\n----------- TEST: WIDTH STR -----------\n\n");
	x = printf("  Originale:\tString [%-25s]\n", "Hello!");
	y = ft_printf("  Ft_printf:\tString [%-25s]\n", "Hello!");
	printf("Printf = %d, ft_printf = %d\n\n", x, y);
	printf("\n----------- TEST: WIDTH HEX -----------\n\n");
	x = printf("  Originale:\tNumber [%*x]\n", 10, 42);
	y = ft_printf("  Ft_printf:\tNumber [%*x]\n",10, 42);
	printf("Printf = %d, ft_printf = %d\n\n", x, y);
	printf("\n----------- TEST: WIDTH UNSIGNED -----------\n\n");
	x = printf("  Originale:\tNumber [%20u]\n", 42);
	y = ft_printf("  Ft_printf:\tNumber [%20u]\n", 42);
	printf("Printf = %d, ft_printf = %d\n\n", x, y);
	printf("\n----------- TEST: WIDTH INT -----------\n\n");
	x = printf("  Originale:\tNumber [%20i]\n", 42);
